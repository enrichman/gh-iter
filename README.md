...
For example the [`client.Teams.ListTeamReposByID`](https://pkg.go.dev/github.com/google/go-github/v65/github#TeamsService.ListTeamReposByID) needs the `orgID, teamID int64` arguments:
...
For example the [`client.Teams.ListIDPGroupsInOrganization`](https://pkg.go.dev/github.com/google/go-github/v65/github#TeamsService.ListIDPGroupsInOrganization) returns a [IDPGroupList](https://pkg.go.dev/github.com/google/go-github/v65/github#IDPGroupList), and not a slice. 
